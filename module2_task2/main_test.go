...
func Test_HelloHandler(t *testing.T) {
  ...
  tests := []struct {
    ...
    {
      name:         "Titi Grominet",
      queryString:  "name=Titi Grominet",
      responseCode: 200,
      body:         "Hello Titi Grominet!",
    },
    {
      name:         "Asterix Obelix",
      queryString:  "name=Asterix Obelix",
      responseCode: 200,
      body:         "Hello Asterix Obelix!",
    },
    {
      name:         "Empty String",
      queryString:  "name=",
    ...
    {
      name:         "no name parameters",
      queryString:  "",
      responseCode: 200,
      body:         "Hello there!",
    },
    {
      name:         "several name parameters",
      queryString:  "name=First Occurence&name=Second Occurence",
      responseCode: 200,
      body:         "Hello Second Occurence!",
    },
